    ...
    if (task === 'module.cancel' || document.formvalidator.isValid(document.getElementById('module-form'))) {
      ...
      if (window.self !== window.top) {
        if (window.parent.viewLevels) {
          ...
          const tmpMenu = window.parent.document.getElementById("menus-".concat(options.itemId));
          const tmpRow = window.parent.document.getElementById("tr-".concat(options.itemId));
          const tmpStatus = window.parent.document.getElementById("status-".concat(options.itemId));
