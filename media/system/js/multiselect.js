...
function getClosest(el, tag) {
  ...
  var elementTag = tag.toUpperCase();
  var element = el;
  ...
  function () {
    ...
    _createClass(JMultiSelect, [{
      ...
      value: function onRowClick(event) {
        ...
        var currentRowNum = this.rows.indexOf(navigator.userAgent.indexOf('MSIE ') > -1 || navigator.userAgent.indexOf('Trident/') > -1 ? getClosest(event.target, 'tr') : event.target.closest('tr'));
