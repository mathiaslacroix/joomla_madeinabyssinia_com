...
((Joomla, window) => {
  ...
  const TinyMCEBuilder = (container, options) => {
    ...
    const appendInput = (element, group, set) => {
      const name = "".concat(options.formControl, "[").concat(set, "][").concat(group, "][]");
      const value = element.getAttribute('data-name');
      const input = "<input type=\"hidden\" name=\"".concat(name, "\" value=\"").concat(value, "\">");
    ...
    const createButton = (name, info, type) => {
      ...
      const $btn = "<button type=\"button\" data-name=\"".concat(name, "\" class=\"").concat(bclass, "\" data-toggle=\"tooltip\" title=\"").concat(title, "\">").concat(content, "</button>");
      return $btn;
    };
    /**
