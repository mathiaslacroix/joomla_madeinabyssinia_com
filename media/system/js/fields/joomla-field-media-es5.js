    ...
    if (resp.success === true) {
      ...
      if (Joomla.selectedFile.url) {
        if (!isElement(editor) && _typeof(editor) !== 'object') {
          Joomla.editors.instances[editor].replaceSelection("<img src=\"".concat(Joomla.selectedFile.url, "\" alt=\"\"/>"));
        } else if (!isElement(editor) && _typeof(editor) === 'object' && editor.id) {
          window.parent.Joomla.editors.instances[editor.id].replaceSelection("<img src=\"".concat(Joomla.selectedFile.url, "\" alt=\"\"/>"));
        } else {
...
(function (customElements, Joomla) {
  ...
  function (_HTMLElement) {
    ...
    function JoomlaFieldMedia() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(JoomlaFieldMedia).call(this));
