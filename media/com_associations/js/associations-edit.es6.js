...
((Joomla, document) => {
  ...
  Joomla.propagateAssociation = (fieldPrefix, callbackFunctionPrefix) => {
    ...
    const assocId = document.getElementById("".concat(fieldPrefix, "_id")).value; // Find the language of the record being edited
    ...
    const url = "".concat(document.forms.adminForm.action, "&").concat(queryString);
    Joomla.request({
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const formControlLanguage = document.getElementById("".concat(formControl, "_language")); // Hide the associations tab if needed
    ...
    if (formControlLanguage) {
      formControlLanguage.addEventListener('change', event => {
        ...
        controlGroup.forEach(element => {
          ...
          const clear = document.getElementById("".concat(formControl, "_associations_").concat(languageCode, "_clear"));
