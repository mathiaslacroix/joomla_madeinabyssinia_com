  ...
  document.addEventListener('DOMContentLoaded', () => {
    document.getElementById('toolbar-load').addEventListener('click', () => {
      ...
      if (ids.length === 1) {
        ...
        const url = "".concat(document.getElementById('toolbar-load').getAttribute('data-url'), "&version_id=").concat(ids[0].value);
    ...
    document.getElementById('toolbar-preview').addEventListener('click', () => {
      ...
      if (ids.length === 1) {
        // Add version item id to URL
        const url = "".concat(document.getElementById('toolbar-preview').getAttribute('data-url'), "&version_id=").concat(ids[0].value);
    ...
    document.getElementById('toolbar-compare').addEventListener('click', () => {
      ...
      if (ids.length === 0) {
        ...
        const url = "".concat(document.getElementById('toolbar-compare').getAttribute('data-url'), "&id1=").concat(ids[0].value, "&id2=").concat(ids[1].value);
