  ...
  class Overrider {
    ...
    insertResults(results) {
      ...
      results.forEach((item, index) => {
        ...
        a.setAttribute('onclick', "Joomla.overrider.selectString(".concat(this.states.counter + index, ");"));
        a.setAttribute('href', '#');
        ...
        key.setAttribute('id', "override_key".concat(this.states.counter + index));
        key.setAttribute('title', item.file);
        key.classList.add('result-key');
        key.innerHTML = item.constant;
        const string = document.createElement('div');
        string.setAttribute('id', "override_string".concat(this.states.counter + index));
