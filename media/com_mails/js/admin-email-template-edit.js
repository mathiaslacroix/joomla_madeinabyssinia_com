  ...
  function () {
    ...
    _createClass(EmailTemplateEdit, [{
      ...
      value: function bindListeners() {
        ...
        var subjectSwitcherChangeHandler = function subjectSwitcherChangeHandler(event) {
        ...
        var bodySwitcherChangeHandler = function bodySwitcherChangeHandler(event) {
        ...
        var htmlBodySwitcherChangeHandler = function htmlBodySwitcherChangeHandler(event) {
